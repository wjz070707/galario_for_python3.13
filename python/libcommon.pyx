...
# _always_ do that, or you will have segfaults#改了
...
cdef class ArrayWrapper:
    ...
    cdef as_ndarray(self, int nx, int ny, void* data_ptr):
        ...
        # Create a 2D array, of length `nx*ny/2+1`#Modified here改了
        ...
        PyArray_SetBaseObject(<np.PyArrayObject*>ndarray, <PyObject*> self)
